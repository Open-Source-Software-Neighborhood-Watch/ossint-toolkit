...
GITHUB_TOKENS = itertools.cycle(["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"])
...
def get_contributor_location(user):
    ...
    # experimental: exit if response is not ok
    else:
        print(f"Contributor location request not ok.\nResponse code: {response}\nResponse text: {response.text}")
...
def get_country_from_location(location_string):
    ...
    location_string = location_string.title()
